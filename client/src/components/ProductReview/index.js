...
const ProductReview = ({ token, setRating, productId, setgetLatestProductUpdate }) => {
    ...
    return (
        <div className="product-reviews pt-3">
            ...
            {isReviewAdded || !token ? null : (
                ...
                <div>
                <h3 className="pt-3">Rate this product:</h3>
                <hr></hr>
                <Form>
                    <FormGroup>
                    <Label for="exampleText">How did you like this product?</Label>
                    <div>
                        <Rating
                    ...
                    <Label for="reviewText">Leave some comments here</Label>
                    <Input
                        type="textarea"
                        name="reviewText"
                        id="reviewText"
